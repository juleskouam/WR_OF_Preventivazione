({
	sendExpenseReport: function(cmp,event,helper){
        ...
        notaSpeseInput.Note__c="Altro - "+notaSpeseInput.Note__c;
        notaSpeseInput.TipoAuto__c="F";
		...
		if(!errorFound){
            ...
            if(notaSpeseInput && notaSpeseInput.ImportoRifornimento__c){
                notaSpeseInput.ImportoRifornimento__c =  notaSpeseInput.ImportoRifornimento__c.replace('.',',');
            }
